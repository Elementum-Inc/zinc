...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    children: patchFlag === -1 && isArray(children2) ? children2.map(deepCloneVNode) : children2,
    target: vnode.target,
...
function createChildrenCodegenNode(branch, keyIndex, context) {
  ...
  if (needFragmentWrapper) {
    if (children2.length === 1 && firstChild.type === 11) {
      ...
      let patchFlag = 64;
      let patchFlagText = PatchFlagNames[64];
      if (!branch.isTemplateIf && children2.filter((c2) => c2.type !== 3).length === 1) {
        patchFlag |= 2048;
        patchFlagText += `, ${PatchFlagNames[2048]}`;
      }
      return createVNodeCall(context, helper(FRAGMENT), createObjectExpression([keyProperty]), children2, patchFlag + ` /* ${patchFlagText} */`, void 0, void 0, true, false, false, branch.loc);
    }
  } else {
...
function hasMultipleChildren(node) {
  const children2 = node.children = node.children.filter((c2) => c2.type !== 3 && !(c2.type === 2 && !c2.content.trim()));
  const child2 = children2[0];
  return children2.length !== 1 || child2.type === 11 || child2.type === 9 && child2.branches.some(hasMultipleChildren);
}
...
const _hoisted_27$2 = /* @__PURE__ */ createBaseVNode("circle", {
  cx: "12",
  cy: "6",
  r: "4",
  fill: "#000",
...
const _hoisted_34$1 = { class: "menu__level0" };
...
const _hoisted_38$1 = ["height", "width", "stroke-width"];
const _hoisted_39$1 = /* @__PURE__ */ createBaseVNode("path", {
  d: "M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z",
  fill: "currentColor"
}, null, -1);
const _hoisted_40$1 = [
...
const _hoisted_47$1 = ["height", "width", "stroke-width"];
const _hoisted_48$1 = /* @__PURE__ */ createBaseVNode("path", {
  d: "M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z",
  fill: "currentColor"
}, null, -1);
const _hoisted_49$1 = [
...
const _hoisted_54 = { class: "image_content__image-container" };
const _hoisted_55 = { key: 2 };
const _hoisted_56 = ["href"];
const _hoisted_57 = { class: "btn__label" };
const _hoisted_58 = ["href"];
const _hoisted_59 = { class: "btn__label" };
const _hoisted_60 = { class: "dropdown" };
...
const _hoisted_64 = /* @__PURE__ */ createBaseVNode("svg", {
  "aria-hidden": "true",
  focusable: "false",
  role: "presentation",
        ...
        default: withCtx(() => [
          createVNode(_component_PopoverPanel, {
            ...
            default: withCtx(({ close }) => [
                                    ...
                                    default: withCtx(() => [
                                      createVNode(_component_DisclosureButton, {
                                        ...
                                        default: withCtx(() => [
                                          createBaseVNode("a", {
                                            href: child2.url
                                          }, toDisplayString(child2.title), 9, _hoisted_16$3),
                                          child2.links.length ? (openBlock(), createElementBlock("span", _hoisted_17$3, [
                                            (openBlock(), createElementBlock("svg", {
                                              xmlns: "http://www.w3.org/2000/svg",
                                              "aria-hidden": "true",
                                              focusable: "false",
              ...
              $props.mobileLinks.length ? (openBlock(), createElementBlock("div", _hoisted_21$3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($props.mobileLinks, (link) => {
                  return openBlock(), createElementBlock("a", {
                    key: link.id,
                    href: link.url
                  }, toDisplayString(link.title), 9, _hoisted_22$3);
                }), 128))
              ])) : createCommentVNode("v-if", true),
                      ...
                      return openBlock(), createBlock(_component_Popover, {
                        ...
                        default: withCtx(() => [
                          (!link.blocks || !link.blocks.length) && (!link.links || !link.links.length) ? (openBlock(), createElementBlock("a", {
                            key: 0,
                            href: link.url
                          }, toDisplayString(link.title), 9, _hoisted_31$1)) : (openBlock(), createBlock(_component_PopoverButton, {
                            key: 1,
                            as: "a",
                            href: link.url
                          }, {
                          ...
                          createVNode(Transition, { name: "slideDown" }, {
                            default: withCtx(() => [
                              link.blocks && link.blocks.length ? (openBlock(), createBlock(_component_PopoverPanel, {
                                  ...
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(link.blocks, (block) => {
                                    return openBlock(), createElementBlock("div", {
                                      ...
                                      block.type == "menu" ? (openBlock(), createElementBlock("div", {
                                        ...
                                        block.settings.submenu_title != "" ? (openBlock(), createElementBlock("h4", _hoisted_32$1, toDisplayString(block.settings.submenu_title), 1)) : (openBlock(), createElementBlock("h4", _hoisted_33$1, toDisplayString(block.settings.submenu.title), 1)),
                                        createBaseVNode("ul", _hoisted_34$1, [
                                              ...
                                              default: withCtx(() => [
                                                link2.links.length ? (openBlock(), createBlock(_component_DisclosureButton, {
                                                  ...
                                                  default: withCtx(() => [
                                                    ...
                                                    ], 8, _hoisted_35$1)) : (openBlock(), createElementBlock("span", _hoisted_36$1, toDisplayString(link2.title), 1)),
                                                    $props.settings.mm_enable_caret ? (openBlock(), createElementBlock("span", _hoisted_37$1, [
                                                      (openBlock(), createElementBlock("svg", {
                                                        xmlns: "http://www.w3.org/2000/svg",
                                                        "aria-hidden": "true",
                                                        focusable: "false",
                                                ...
                                                link2.links.length ? (openBlock(), createBlock(Transition, {
                                                  ...
                                                  default: withCtx(() => [
                                                    createVNode(_component_DisclosurePanel, {
                                                      ...
                                                      default: withCtx(() => [
                                                        $props.settings.mm_toplink_behavior == "view_all_link" ? (openBlock(), createElementBlock("li", _hoisted_42$1, [
                                                          createBaseVNode("a", {
                                                            href: link2.url
                                                          }, " All " + toDisplayString(link2.title), 9, _hoisted_43$1)
                                                        ])) : createCommentVNode("v-if", true),
                                                              ...
                                                              child2.links.length ? (openBlock(), createBlock(_component_DisclosureButton, {
                                                                ...
                                                                default: withCtx(() => [
                                                                  $props.settings.mm_toplink_behavior == "parent_link" ? (openBlock(), createElementBlock("a", {
                                                                    key: 0,
                                                                    href: child2.url
                                                                  }, toDisplayString(child2.title), 9, _hoisted_44$1)) : (openBlock(), createElementBlock("span", _hoisted_45$1, toDisplayString(child2.title), 1)),
                                                                  $props.settings.mm_enable_caret ? (openBlock(), createElementBlock("span", _hoisted_46$1, [
                                                                    (openBlock(), createElementBlock("svg", {
                                                                      xmlns: "http://www.w3.org/2000/svg",
                                                                      "aria-hidden": "true",
                                                                      focusable: "false",
                                                                ...
                                                                key: 1,
                                                                href: child2.url
                                                              }, toDisplayString(child2.title), 9, _hoisted_50$1)),
                                                              child2.links.length ? (openBlock(), createBlock(Transition, {
                                                                key: 2,
                                                                name: "slideDown"
                                                              }, {
                                                                default: withCtx(() => [
                                                                  createVNode(_component_DisclosurePanel, {
                                                                    ...
                                                                    default: withCtx(() => [
                                                                      $props.settings.mm_toplink_behavior == "view_all_link" ? (openBlock(), createElementBlock("li", _hoisted_51$1, [
                                                                        createBaseVNode("a", {
                                                                          href: child2.url
                                                                        }, " All " + toDisplayString(child2.title), 9, _hoisted_52$1)
                                                                      ])) : createCommentVNode("v-if", true),
                                                                      (openBlock(true), createElementBlock(Fragment, null, renderList(child2.links, (grandchild) => {
                                                                        return openBlock(), createElementBlock("li", {
                                                                          key: grandchild.id
                                                                          ...
                                                                          createBaseVNode("a", {
                                                                            href: grandchild.url
                                                                          }, toDisplayString(grandchild.title), 9, _hoisted_53$1)
                                                                        ]);
                                                                      }), 128))
                                                                    ]),
                                                                    _: 2
                                        ...
                                        block.settings.content_title || block.settings.content_subtitle || block.settings.content || block.settings.primary_button_label && block.settings.primary_button_url || block.settings.secondary_button_label && block.settings.secondary_button_url ? (openBlock(), createElementBlock("div", {
                                          ...
                                          }, toDisplayString(block.settings.content_title), 3)) : createCommentVNode("v-if", true),
                                          block.settings.content_subtitle ? (openBlock(), createElementBlock("h4", {
                                            key: 1,
                                            class: normalizeClass(block.settings.content_subtitle_size)
                                          }, toDisplayString(block.settings.content_subtitle), 3)) : createCommentVNode("v-if", true),
                                          block.settings.content ? (openBlock(), createElementBlock("div", _hoisted_55, toDisplayString(block.settings.content), 1)) : createCommentVNode("v-if", true),
                                          createBaseVNode("div", {
                                            ...
                                            block.settings.primary_button_label && block.settings.primary_button_url ? (openBlock(), createElementBlock("a", {
                                              ...
                                              createBaseVNode("span", _hoisted_57, toDisplayString(block.settings.primary_button_label), 1)
                                            ], 10, _hoisted_56)) : createCommentVNode("v-if", true),
                                            block.settings.secondary_button_label && block.settings.secondary_button_url ? (openBlock(), createElementBlock("a", {
                                              ...
                                              createBaseVNode("span", _hoisted_59, toDisplayString(block.settings.secondary_button_label), 1)
                                            ], 10, _hoisted_58)) : createCommentVNode("v-if", true)
                                          ], 2)
                                ...
                                default: withCtx(() => [
                                  createBaseVNode("ul", _hoisted_60, [
                                          ...
                                          child2.links.length ? (openBlock(), createBlock(_component_DisclosureButton, { key: 0 }, {
                                            default: withCtx(() => [
                                              $props.settings.mm_toplink_behavior == "parent_link" ? (openBlock(), createElementBlock("a", {
                                                key: 0,
                                                href: child2.url
                                              }, toDisplayString(child2.title), 9, _hoisted_61)) : (openBlock(), createElementBlock("span", _hoisted_62, toDisplayString(child2.title), 1)),
                                              child2.links.length ? (openBlock(), createElementBlock("span", _hoisted_63, _hoisted_65)) : createCommentVNode("v-if", true)
                                            ]),
                                            _: 2
                                          }, 1024)) : (openBlock(), createElementBlock("a", {
                                            key: 1,
                                            href: child2.url
                                          }, toDisplayString(child2.title), 9, _hoisted_66)),
                                          child2.links.length ? (openBlock(), createBlock(Transition, {
                                            key: 2,
                                            name: "slideDown"
                                          }, {
                                            default: withCtx(() => [
                                              createVNode(_component_DisclosurePanel, { as: "ul" }, {
                                                default: withCtx(() => [
                                                  $props.settings.mm_toplink_behavior == "view_all_link" ? (openBlock(), createElementBlock("li", _hoisted_67, [
                                                    createBaseVNode("a", {
                                                      href: child2.url
                                                    }, " All " + toDisplayString(child2.title), 9, _hoisted_68)
                                                  ])) : createCommentVNode("v-if", true),
                                                  (openBlock(true), createElementBlock(Fragment, null, renderList(child2.links, (grandchild) => {
                                                    return openBlock(), createElementBlock("li", {
                                                      key: grandchild.id,
                                                      ...
                                                      createBaseVNode("a", {
                                                        href: grandchild.url
                                                      }, toDisplayString(grandchild.title), 9, _hoisted_69)
                                                    ]);
                                                  }), 128))
                                                ]),
                                                _: 2
      ...
      createBaseVNode("div", {
        ...
        createBaseVNode("div", _hoisted_5$2, [
          ...
          createBaseVNode("div", {
            ...
            }, _hoisted_11$2, 10, _hoisted_9$2)) : createCommentVNode("v-if", true),
            ...
            }, _hoisted_14$2, 10, _hoisted_12$2)) : createCommentVNode("v-if", true)
          ], 2)
        ])
      ], 6),
        ...
        createBaseVNode("div", _hoisted_16$2, [
          $props.cardType == "article" ? (openBlock(), createElementBlock("div", _hoisted_17$2, [
            createBaseVNode("div", _hoisted_18$2, [
              $props.showTags && $props.card.tags.size > 0 ? (openBlock(), createElementBlock("span", _hoisted_19$2, toDisplayString($props.card.tags.join(", ").substring(0, 25)), 1)) : createCommentVNode("v-if", true),
              $props.showDate ? (openBlock(), createElementBlock("span", _hoisted_20$2, toDisplayString($options.formattedDate), 1)) : createCommentVNode("v-if", true),
              $props.showAuthor ? (openBlock(), createElementBlock("span", _hoisted_21$2, toDisplayString($props.card.author), 1)) : createCommentVNode("v-if", true)
            ])
          ])) : createCommentVNode("v-if", true),
          createBaseVNode("h3", {
            class: "card__heading",
          ...
          createBaseVNode("div", _hoisted_24$1, [
            ...
            $props.cardType == "product" && $props.showPrice ? (openBlock(), createElementBlock("div", _hoisted_28, [
      ...
      createBaseVNode("div", _hoisted_41, [
        createBaseVNode("div", _hoisted_42, [
          ...
          createBaseVNode("div", _hoisted_44, [
            $props.showVendor ? (openBlock(), createElementBlock("div", _hoisted_45, _hoisted_48)) : createCommentVNode("v-if", true),
...
const _hoisted_21$1 = { class: "search__articles shopify-grid product-grid grid--2-col-tablet-down grid--4-col-desktop" };
                        ...
                        createBaseVNode("div", _hoisted_16$1, [
                          (openBlock(true), createElementBlock(Fragment, null, renderList($props.trendingSearches.links, (trend) => {
                            return openBlock(), createElementBlock("a", {
                              ...
                              createBaseVNode("span", _hoisted_18$1, toDisplayString(trend.title), 1)
                            ], 8, _hoisted_17$1);
                          }), 128))
                        ])
                      ])) : createCommentVNode("v-if", true),
