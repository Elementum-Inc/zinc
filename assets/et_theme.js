...
function forOwn(object, iteratee, right) {
  if (object) {
    (right ? ownKeys$1(object).reverse() : ownKeys$1(object)).forEach(function (
      key
    ) {
  ...
  slice(arguments, 1).forEach(function (source) {
    forOwn(source, function (value, key) {
      if (isArray$1(value)) {
        ...
        object[key] = merge(
          {},
          isObject$1(object[key]) ? object[key] : {},
          value
        );
      } else {
        object[key] = value;
  ...
  function reduce(enable) {
    if (matchMedia(MEDIA_PREFERS_REDUCED_MOTION).matches) {
      enable
        ...
        : omit(options, ownKeys$1(reducedMotion));
    }
  }
...
function Elements(Splide2, Components2, options) {
  ...
  function collect() {
    ...
    assert$1(track2 && list, "A track/list element is missing.");
    push(
      slides,
...
function Slides(Splide2, Components2, options) {
  ...
  function filter(matcher) {
    return Slides2.filter(
      isFunction$1(matcher)
        ? matcher
        : function (Slide2) {
            return isString$1(matcher)
              ? matches$1(Slide2.slide, matcher)
...
function Layout(Splide2, Components2, options) {
  ...
  function cssPadding(right) {
    ...
    return (
      (padding && unit(padding[prop] || (isObject$1(padding) ? 0 : padding))) ||
      "0px"
    );
  }
  ...
  function slideSize(index, withoutGap) {
    ...
    return Slide2
      ? rect(Slide2.slide)[resolve2("width")] + (withoutGap ? 0 : getGap())
      : 0;
  }
  ...
  function getGap() {
    var Slide2 = getAt(0);
    return (
      (Slide2 && parseFloat(style(Slide2.slide, resolve2("marginRight")))) || 0
    );
  }
  function getPadding(right) {
    return (
      parseFloat(
        style(track2, resolve2("padding" + (right ? "Right" : "Left")))
      ) || 0
    );
  }
  function isOverflow() {
...
function Clones(Splide2, Components2, options) {
  ...
  function computeCloneCount() {
    ...
    if (!Splide2.is(LOOP)) {
      ...
      var fixedSize =
        options[resolve2("fixedWidth")] && Components2.Layout.slideSize(0);
      var fixedCount =
        fixedSize && ceil(rect(Elements2.track)[resolve2("width")] / fixedSize);
      clones2 =
        fixedCount ||
        (options[resolve2("autoWidth")] && Splide2.length) ||
...
function Move(Splide2, Components2, options) {
  ...
  var _Components2$Directio = Components2.Direction,
    resolve2 = _Components2$Directio.resolve,
  ...
  function translate(position, preventLoop) {
    if (!Splide2.is(FADE)) {
      ...
      style(
        list,
        "transform",
        "translate" + resolve2("X") + "(" + destination + "px)"
      );
  ...
  function canShift(backwards) {
    ...
    return backwards
      ? shifted >= 0
      : shifted <=
          list[resolve2("scrollWidth")] - rect(track2)[resolve2("width")];
  }
...
function Drag(Splide2, Components2, options) {
  ...
  var _Components2$Directio2 = Components2.Direction,
    resolve2 = _Components2$Directio2.resolve,
  ...
  function isDraggable(target2) {
    ...
    return (
      !matches$1(target2, "." + CLASS_PAGINATION_PAGE + ", ." + CLASS_ARROW) &&
      (!noDrag || !matches$1(target2, noDrag))
    );
  }
...
function generateCodeFrame(source, start = 0, end = source.length) {
  ...
  for (let i2 = 0; i2 < lines.length; i2++) {
    count +=
      lines[i2].length +
      ((newlineSequences[i2] && newlineSequences[i2].length) || 0);
    if (count >= start) {
      for (let j2 = i2 - range; j2 <= i2 + range || end > count; j2++) {
        ...
        const newLineSeqLength =
          (newlineSequences[j2] && newlineSequences[j2].length) || 0;
        if (j2 === i2) {
...
class RefImpl {
  ...
  set value(newVal) {
    const useDirectValue =
      this.__v_isShallow || isShallow$1(newVal) || isReadonly(newVal);
    ...
    while (cur) {
      ...
      if (errorCapturedHooks) {
        for (let i2 = 0; i2 < errorCapturedHooks.length; i2++) {
          if (
            errorCapturedHooks[i2](err, exposedInstance, errorInfo) === false
          ) {
            return;
          }
        }
...
const devtoolsPerfStart =
  /* @__PURE__ */ createDevtoolsPerformanceHook("perf:start");
const devtoolsPerfEnd =
  /* @__PURE__ */ createDevtoolsPerformanceHook("perf:end");
...
function emit$1(instance, event2, ...rawArgs) {
    ...
    if (emitsOptions) {
      if (!(event2 in emitsOptions) && true) {
        if (!propsOptions || !(toHandlerKey(event2) in propsOptions)) {
          warn(
            `Component emitted event "${event2}" but it is neither declared in the emits option nor as an "${toHandlerKey(
              event2
            )}" prop.`
          );
        }
  ...
  let handlerName;
  let handler =
    props[(handlerName = toHandlerKey(event2))] ||
...
function normalizeSuspenseChildren(vnode) {
  ...
  vnode.ssFallback = isSlotChildren
    ? normalizeSuspenseSlot(children2.fallback)
  ...
  const job = () => {
    ...
    if (cb) {
      ...
      if (
        ...
        forceTrigger ||
        (isMultiSource
          ? newValue.some((v2, i2) => hasChanged(v2, oldValue[i2]))
...
function getTransitionRawChildren(children2, keepComment = false, parentKey) {
  ...
  for (let i2 = 0; i2 < children2.length; i2++) {
    ...
    const key =
      parentKey == null
        ? child2.key
        : String(parentKey) + String(child2.key != null ? child2.key : i2);
    if (child2.type === Fragment) {
      if (child2.patchFlag & 128) keyedFragmentCount++;
      ret = ret.concat(
        getTransitionRawChildren(child2.children, keepComment, key)
      );
...
function renderList(source, renderItem, cache, index) {
  ...
  if (isArray(source) || isString(source)) {
    ...
    if (source[Symbol.iterator]) {
      ret = Array.from(source, (item, i2) =>
        renderItem(item, i2, void 0, cached && cached[i2])
      );
    } else {
...
function renderSlot(slots, name, props = {}, fallback, noSlotted) {
  ...
  const rendered = createBlock(
    ...
    {
      key:
        props.key || (validSlotContent && validSlotContent.key) || `_${name}`,
    },
...
function resolveMergedOptions(instance) {
  ...
  if (cached) {
    ...
    if (globalMixins.length) {
      globalMixins.forEach((m2) =>
        mergeOptions(resolved, m2, optionMergeStrategies, true)
      );
    }
  ...
  const hydrateChildren = (
    ...
    for (let i2 = 0; i2 < l2; i2++) {
      const vnode = optimized
        ? children2[i2]
        : (children2[i2] = normalizeVNode(children2[i2]));
      if (node) {
        node = hydrateNode(
          node,
          vnode,
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const mountChildren = (
    ...
    for (let i2 = start; i2 < children2.length; i2++) {
      const child2 = (children2[i2] = optimized
        ? cloneIfMounted(children2[i2])
        : normalizeVNode(children2[i2]));
      patch(
        null,
        child2,
        container,
  ...
  const setupRenderEffect = (
    ...
    toggleRecurse(instance, true);
    {
      effect2.onTrack = instance.rtc
        ? (e2) => invokeArrayFns(instance.rtc, e2)
        : void 0;
      effect2.onTrigger = instance.rtg
        ? (e2) => invokeArrayFns(instance.rtg, e2)
        : void 0;
  ...
  const patchUnkeyedChildren = (
    ...
    for (i2 = 0; i2 < commonLength; i2++) {
      const nextChild = (c2[i2] = optimized
        ? cloneIfMounted(c2[i2])
        : normalizeVNode(c2[i2]));
      patch(
        c1[i2],
        nextChild,
        container,
    ...
    if (i2 > e1) {
      ...
      for (i2 = s1; i2 <= e1; i2++) {
        ...
        if (prevChild.key != null) {
          ...
          for (j2 = s2; j2 <= e2; j2++) {
            if (
              newIndexToOldIndexMap[j2 - s2] === 0 &&
              isSameVNodeType(prevChild, c2[j2])
            ) {
              newIndex = j2;
              break;
            }
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    children:
      patchFlag === -1 && isArray(children2)
        ? children2.map(deepCloneVNode)
        : children2,
    target: vnode.target,
...
function normalizeVNode(child2) {
  if (child2 == null || typeof child2 === "boolean") {
    ...
    return createVNode(Fragment, null, child2.slice());
...
function cloneIfMounted(child2) {
  return (child2.el === null && child2.patchFlag !== -1) || child2.memo
    ? child2
    : cloneVNode(child2);
}
...
const classify = (str) =>
  str.replace(classifyRE, (c2) => c2.toUpperCase()).replace(/[-_]/g, "");
...
const getNow = () =>
  cachedNow || (p$3.then(() => (cachedNow = 0)), (cachedNow = Date.now()));
...
const Transition = (props, { slots }) =>
  h$2(BaseTransition, resolveTransitionProps(props), slots);
  ...
  created(el, { value, modifiers: { number } }, vnode) {
    ...
    addEventListener(el, "change", () => {
      const selectedVal = Array.prototype.filter
        .call(el.options, (o2) => o2.selected)
        .map((o2) => (number ? toNumber(getValue(o2)) : getValue(o2)));
      el._assign(
        el.multiple
          ? isSetModel
            ? new Set(selectedVal)
...
const modifierGuards = {
  ...
  exact: (e2, modifiers) =>
    systemModifiers.some((m2) => e2[`${m2}Key`] && !modifiers.includes(m2)),
};
    ...
    switch (state) {
      case 0:
        if (char === "[") {
          ...
          !(i2 === 0 ? validFirstIdentCharRE : validIdentCharRE).test(char)
        ) {
          return false;
        }
        break;
...
function findDir(node, name, allowEmpty = false) {
  for (let i2 = 0; i2 < node.props.length; i2++) {
    ...
    if (
      p2.type === 7 &&
      (allowEmpty || p2.exp) &&
      (isString(name) ? p2.name === name : name.test(p2.name))
    ) {
      return p2;
    }
  }
...
function hasDynamicKeyVBind(node) {
  return node.props.some(
    (p2) =>
      p2.type === 7 &&
      p2.name === "bind" &&
      (!p2.arg || p2.arg.type !== 4 || !p2.arg.isStatic)
  );
}
...
const defaultParserOptions = {
  ...
  decodeEntities: (rawText) =>
    rawText.replace(decodeRE, (_2, p1) => decodeMap[p1]),
...
function parseTag(context, type, parent) {
  ...
  if (!context.inVPre) {
    if (tag === "slot") {
      ...
      if (
        props.some((p2) => p2.type === 7 && isSpecialTemplateDirective(p2.name))
      ) {
        tagType = 3;
      }
  ...
  for (let i2 = 0; i2 < children2.length; i2++) {
    ...
    if (child2.type === 1 && child2.tagType === 0) {
      const constantType = doNotHoistNode
        ? 0
        : getConstantType(child2, context);
      if (constantType > 0) {
        if (constantType >= 2) {
          child2.codegenNode.patchFlag = -1 + ` /* HOISTED */`;
        ...
        if (codegenNode.type === 13) {
          ...
          if (
            ...
            getGeneratedPropsConstantType(child2, context) >= 2
          ) {
    ...
    if (child2.type === 1) {
      ...
      for (let i3 = 0; i3 < child2.branches.length; i3++) {
        walk(
          child2.branches[i3],
          context,
          child2.branches[i3].children.length === 1
        );
      }
    }
  }
...
function createRootCodegen(root, context) {
  ...
  if (children2.length === 1) {
    ...
    if (children2.filter((c2) => c2.type !== 3).length === 1) {
      patchFlag |= 2048;
...
function genNodeListAsArray(nodes, context) {
  const multilines =
    nodes.length > 3 || nodes.some((n2) => isArray(n2) || !isText$1(n2));
  context.push(`[`);
...
function genVNodeCall(node, context) {
  ...
  genNodeList(
    genNullableArgs([tag, props, children2, patchFlag, dynamicProps]),
    context
  );
  push2(`)`);
  if (isBlock) {
...
function genObjectExpression(node, context) {
  ...
  const multilines =
    properties.length > 1 || properties.some((p2) => p2.value.type !== 4);
  push2(multilines ? `{` : `{ `);
  multilines && indent();
  for (let i2 = 0; i2 < properties.length; i2++) {
    const { key, value } = properties[i2];
...
function createChildrenCodegenNode(branch, keyIndex, context) {
  ...
  if (needFragmentWrapper) {
    if (children2.length === 1 && firstChild.type === 11) {
      ...
      if (
        !branch.isTemplateIf &&
        children2.filter((c2) => c2.type !== 3).length === 1
      ) {
        patchFlag |= 2048;
        patchFlagText += `, ${PatchFlagNames[2048]}`;
      }
    ...
    return processFor(node, dir, context, (forNode) => {
      ...
      return () => {
        ...
        const needFragmentWrapper =
          children2.length !== 1 || children2[0].type !== 1;
...
function createParamsList(args) {
  ...
  return args
    .slice(0, i2 + 1)
    .map((arg, i3) => arg || createSimpleExpression(`_`.repeat(i3 + 1), false));
}
...
const buildClientSlotFn = (props, children2, loc) =>
  createFunctionExpression(
    props,
    children2,
    false,
...
const transformElement = (node, context) => {
  return function postTransformElement() {
    ...
    let shouldUseBlock =
      ...
      vnodeTag === TELEPORT ||
      vnodeTag === SUSPENSE ||
      (!isComponent2 && (tag === "svg" || tag === "foreignObject"));
    if (props.length > 0) {
    ...
    if (node.children.length > 0) {
      ...
      const shouldBuildAsSlots =
        isComponent2 && vnodeTag !== TELEPORT && vnodeTag !== KEEP_ALIVE;
    ...
    if (patchFlag !== 0) {
      {
        if (patchFlag < 0) {
          ...
          const flagNames = Object.keys(PatchFlagNames)
            .map(Number)
            .filter((n2) => n2 > 0 && patchFlag & n2)
            .map((n2) => PatchFlagNames[n2])
            .join(`, `);
...
function buildProps(
  ...
  const analyzePatchFlag = ({ key, value }) => {
    if (isStaticExp(key)) {
      ...
      if (
        isEventHandler &&
        (!isComponent2 || isDynamicComponent) &&
...
const transformText = (node, context) => {
  if (
    ...
    return () => {
      ...
      for (let i2 = 0; i2 < children2.length; i2++) {
        const child2 = children2[i2];
        if (isText(child2) || child2.type === 8) {
          const callArgs = [];
...
const transformModel$1 = (dir, node, context) => {
  ...
  if (dir.modifiers.length && node.tagType === 1) {
    const modifiers = dir.modifiers
      .map(
        (m2) => (isSimpleIdentifier(m2) ? m2 : JSON.stringify(m2)) + `: true`
      )
      .join(`, `);
        ...
        if (
          parent.props.some(
            (a2) =>
              ...
              a2.name === "encoding" &&
              a2.value != null &&
              (a2.value.content === "text/html" ||
                a2.value.content === "application/xhtml+xml")
          )
        ) {
          ns = 0;
        }
...
const transformClick = (key, event2) => {
  ...
  return isStaticClick
    ? createSimpleExpression(event2, true)
    : key.type !== 4
    ? createCompoundExpression([
        `(`,
        key,
...
function hasMultipleChildren(node) {
  const children2 = (node.children = node.children.filter(
    (c2) => c2.type !== 3 && !(c2.type === 2 && !c2.content.trim())
  ));
  const child2 = children2[0];
  return (
    children2.length !== 1 ||
    child2.type === 11 ||
    (child2.type === 9 && child2.branches.some(hasMultipleChildren))
  );
}
...
var R$1 = ((o2) => (
    (o2[(o2.None = 0)] = "None"),
    (o2[(o2.RenderStrategy = 1)] = "RenderStrategy"),
    (o2[(o2.Static = 2)] = "Static"),
    o2
  ))(R$1 || {}),
  O$1 = ((e2) => (
...
function P$3({
  ...
  var a2;
  let n2 = k$1(o2, e2),
    s2 = Object.assign(i2, { props: n2 });
  if (r2 || (t2 & 2 && n2.static)) return p$2(s2);
  if (t2 & 1) {
    ...
    return u$4(l2, {
      ...
      [1]() {
        return p$2({
          ...i2,
          props: { ...n2, hidden: true, style: { display: "none" } },
        });
      },
    });
  }
...
function p$2({ props: r2, attrs: t2, slots: e2, slot: o2, name: i2 }) {
  var y2;
  let { as: n2, ...s2 } = w$4(r2, ["unmount", "static"]),
    a2 = (y2 = e2.default) == null ? void 0 : y2.call(e2, o2),
    l2 = {};
  if (o2) {
    let d2 = false,
      u2 = [];
  ...
  if (n2 === "template") {
    if (
      ((a2 = g$3(a2 != null ? a2 : [])),
      Object.keys(s2).length > 0 || Object.keys(t2).length > 0)
    ) {
      ...
      if (!x$2(d2) || u2.length > 0)
        throw new Error(
          [
            ...
            Object.keys(s2)
              .concat(Object.keys(t2))
              .sort((f2, c2) => f2.localeCompare(c2))
              .map((f2) => `  - ${f2}`).join(`
`),
            "",
...
function k$1(...r2) {
  ...
  for (let i2 of r2)
    for (let n2 in i2)
      n2.startsWith("on") && typeof i2[n2] == "function"
        ? (e2[n2] != null || (e2[n2] = []), e2[n2].push(i2[n2]))
        : (t2[n2] = i2[n2]);
  if (t2.disabled || t2["aria-disabled"])
    return Object.assign(
      t2,
      Object.fromEntries(Object.keys(e2).map((i2) => [i2, void 0]))
    );
  for (let i2 in e2)
    Object.assign(t2, {
      [i2](n2, ...s2) {
...
function x$2(r2) {
  return r2 == null
    ? false
    : typeof r2.type == "string" ||
        typeof r2.type == "object" ||
        typeof r2.type == "function";
}
let e$2 = 0;
function n$2() {
  return ++e$2;
...
var l$2 = ((e2) => (
  (e2[(e2.Open = 0)] = "Open"), (e2[(e2.Closed = 1)] = "Closed"), e2
))(l$2 || {});
function f$1() {
  return p$1() !== null;
}
...
function b$2(t2, e2) {
  ...
  return (
    ...
    watchEffect(() => {
      ...
      n2.value ||
        !o$1(e2) ||
        (o$1(e2) instanceof HTMLButtonElement &&
          !((o2 = o$1(e2)) != null && o2.hasAttribute("type")) &&
          (n2.value = "button"));
    }),
    n2
  );
...
var M = ((n2) => (
  ...
  N = ((o2) => (
    (o2[(o2.Error = 0)] = "Error"),
    (o2[(o2.Overflow = 1)] = "Overflow"),
    (o2[(o2.Success = 2)] = "Success"),
    (o2[(o2.Underflow = 3)] = "Underflow"),
    o2
  ))(N || {}),
  b$1 = ((r2) => (
    (r2[(r2.Previous = -1)] = "Previous"), (r2[(r2.Next = 1)] = "Next"), r2
  ))(b$1 || {});
function E$2(e2 = document.body) {
  return e2 == null ? [] : Array.from(e2.querySelectorAll(m$1));
}
var F$2 = ((r2) => (
  (r2[(r2.Strict = 0)] = "Strict"), (r2[(r2.Loose = 1)] = "Loose"), r2
))(F$2 || {});
function h$1(e2, t2 = 0) {
  var r2;
  return e2 === ((r2 = m$2(e2)) == null ? void 0 : r2.body)
    ? false
    : u$4(t2, {
        [0]() {
...
function O(e2, t2 = (r2) => r2) {
  return e2.slice().sort((r2, l2) => {
    let o2 = t2(r2),
      s2 = t2(l2);
    if (o2 === null || s2 === null) return 0;
    let n2 = o2.compareDocumentPosition(s2);
    return n2 & Node.DOCUMENT_POSITION_FOLLOWING
      ? -1
      : n2 & Node.DOCUMENT_POSITION_PRECEDING
      ? 1
      : 0;
  });
}
function P$2(e2, t2, r2 = true, l2 = null) {
  ...
  let o2 =
      (c2 = Array.isArray(e2)
        ...
        : e2 == null
        ? void 0
        : e2.ownerDocument) != null
        ? c2
        : document,
    s2 = Array.isArray(e2) ? (r2 ? O(e2) : e2) : E$2(e2);
  ...
  let n2 = (() => {
    ...
    x2 = (() => {
      if (t2 & 1) return 0;
      if (t2 & 2) return Math.max(0, s2.indexOf(l2)) - 1;
      if (t2 & 4) return Math.max(0, s2.indexOf(l2)) + 1;
      if (t2 & 8) return s2.length - 1;
      throw new Error(
        "Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last"
      );
    })(),
    ...
    u2;
  do {
    if (a2 >= i2 || a2 + i2 <= 0) return 0;
    let f2 = x2 + a2;
    if (t2 & 16) f2 = (f2 + i2) % i2;
    else {
      if (f2 < 0) return 3;
      if (f2 >= i2) return 1;
    }
  ...
  e$1 ||
    watchEffect((o2) => {
      document.addEventListener(e2, t2, n2),
        o2(() => document.removeEventListener(e2, t2, n2));
    });
}
function y(f2, m2, i2 = computed(() => true)) {
  function a2(e2, u2) {
    if (!i2.value || e2.defaultPrevented) return;
    let n2 = u2(e2);
    if (n2 === null || !n2.getRootNode().contains(n2)) return;
    ...
    for (let o2 of c2) {
      ...
      if (t2 != null && t2.contains(n2)) return;
    }
    return (
      !h$1(n2, F$2.Loose) && n2.tabIndex !== -1 && e2.preventDefault(),
      m2(e2, n2)
    );
  }
  let r2 = ref(null);
  v$1(
    ...
    (e2) => {
      ...
      i2.value &&
        (r2.value =
          ((n2 = (u2 = e2.composedPath) == null ? void 0 : u2.call(e2)) == null
            ? void 0
            : n2[0]) || e2.target);
    },
    true
...
let f = defineComponent({
  ...
  setup(r2, { slots: t2, attrs: d2 }) {
    return () => {
      let { features: e2, ...o2 } = r2,
        n2 = {
          "aria-hidden": (e2 & 2) === 2 ? true : void 0,
          style: {
            position: "fixed",
            top: 1,
            left: 1,
...
function w$2(e2, n2, t2) {
  e$1 ||
    watchEffect((o2) => {
      window.addEventListener(e2, n2, t2),
        o2(() => window.removeEventListener(e2, n2, t2));
    });
}
var d$3 = ((r2) => (
  ...
  e$1 ||
    watchEffect((t2) => {
      (n2 = n2 != null ? n2 : window),
        n2.addEventListener(e2, o2, r2),
        t2(() => n2.removeEventListener(e2, o2, r2));
    });
}
function t(e2) {
...
var h = ((e2) => (
  (e2[(e2.None = 1)] = "None"),
  (e2[(e2.InitialFocus = 2)] = "InitialFocus"),
  (e2[(e2.TabLock = 4)] = "TabLock"),
  (e2[(e2.FocusLock = 8)] = "FocusLock"),
  (e2[(e2.RestoreFocus = 16)] = "RestoreFocus"),
  (e2[(e2.All = 30)] = "All"),
  e2
))(h || {});
let ee$1 = Object.assign(
  defineComponent({
    name: "FocusTrap",
    props: {
      as: { type: [Object, String], default: "div" },
      ...
      containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) },
    },
    inheritAttrs: false,
    setup(u2, { attrs: a$1, slots: t2, expose: r2 }) {
      let n$12 = ref(null);
      r2({ el: n$12, $el: n$12 });
      let o2 = computed(() => m$2(n$12));
      A$1(
        { ownerDocument: o2 },
        computed(() => Boolean(u2.features & 16))
      );
      let e2 = C$1(
        {
          ownerDocument: o2,
          container: n$12,
          initialFocus: computed(() => u2.initialFocus),
        },
        computed(() => Boolean(u2.features & 2))
      );
      _$1(
        {
          ownerDocument: o2,
          container: n$12,
          containers: u2.containers,
          previousActiveElement: e2,
        },
        computed(() => Boolean(u2.features & 8))
      );
      let s2 = n();
      function i2() {
        let l2 = o$1(n$12);
        !l2 ||
          u$4(s2.value, {
            [d$3.Forwards]: () => P$2(l2, M.First),
            [d$3.Backwards]: () => P$2(l2, M.Last),
          });
      }
      return () => {
        let l2 = {},
          c2 = { ref: n$12 },
          { features: f$12, initialFocus: p2, containers: U, ...y2 } = u2;
        return h$2(Fragment, [
          Boolean(f$12 & 4) &&
            h$2(f, {
              as: "button",
...
function A$1({ ownerDocument: u2 }, a2) {
  ...
  function r2() {
    var o2;
    t2.value ||
      (t2.value = (o2 = u2.value) == null ? void 0 : o2.activeElement);
  }
  function n2() {
...
function C$1({ ownerDocument: u2, container: a2, initialFocus: t$12 }, r2) {
  let n2 = ref(null),
    o2 = ref(false);
  return (
    onMounted(() => (o2.value = true)),
    onUnmounted(() => (o2.value = false)),
    onMounted(() => {
      watch(
        [a2, t$12, r2],
        (e2, s2) => {
          if (
            e2.every((l2, c2) => (s2 == null ? void 0 : s2[c2]) === l2) ||
            !r2.value
          )
            return;
          let i2 = o$1(a2);
          !i2 ||
            t(() => {
              ...
              if (!o2.value) return;
              let l2 = o$1(t$12),
                c2 = (f2 = u2.value) == null ? void 0 : f2.activeElement;
              if (l2) {
                if (l2 === c2) {
                  n2.value = c2;
                  return;
              ...
              l2
                ? w$3(l2)
                : P$2(i2, M.First | M.NoScroll) === N.Error &&
                  console.warn(
                    "There are no focusable elements inside the <FocusTrap />"
                  ),
                (n2.value =
                  (p2 = u2.value) == null ? void 0 : p2.activeElement);
            });
        },
...
function _$1(
  {
    ...
    container: a2,
    containers: t2,
    previousActiveElement: r2,
  },
  n2
) {
  var o2;
  E$1(
    (o2 = u2.value) == null ? void 0 : o2.defaultView,
    "focus",
    (e2) => {
      if (!n2.value) return;
      ...
      if (!i2) return;
      let l2 = e2.target;
      l2 && l2 instanceof HTMLElement
        ? x$1(s2, l2)
          ? ((r2.value = l2), w$3(l2))
          : (e2.preventDefault(), e2.stopPropagation(), w$3(i2))
        : w$3(r2.value);
    },
    true
  );
...
function x$1(u2, a2) {
  var t2;
  for (let r2 of u2)
    if ((t2 = r2.value) != null && t2.contains(a2)) return true;
  return false;
}
let l$1 = "body > *",
  i = /* @__PURE__ */ new Set(),
...
function s$1(t2) {
  ...
  !n2 ||
    (n2["aria-hidden"] === null
      ...
      : t2.setAttribute("aria-hidden", n2["aria-hidden"]),
    (t2.inert = n2.inert));
}
function g$2(t2, n2 = ref(true)) {
  watchEffect((d2) => {
    if (!n2.value || !t2.value) return;
    let a2 = t2.value,
      o2 = m$2(a2);
    if (!!o2) {
      i.add(a2);
      for (let e2 of r.keys()) e2.contains(a2) && (s$1(e2), r.delete(e2));
      o2.querySelectorAll(l$1).forEach((e2) => {
        if (e2 instanceof HTMLElement) {
          for (let f2 of i) if (e2.contains(f2)) return;
          i.size === 1 &&
            (r.set(e2, {
        ...
        d2(() => {
          ...
          else for (let e2 of r.keys()) s$1(e2), r.delete(e2);
        });
    }
  });
}
...
function c(t2) {
  ...
  if (!r2) {
    ...
    throw new Error(
      `[Headless UI]: Cannot find ownerDocument for contextElement: ${t2}`
    );
  }
  ...
  return (
    e2.setAttribute("id", "headlessui-portal-root"), r2.body.appendChild(e2)
  );
}
let R = defineComponent({
    name: "Portal",
    props: { as: { type: [Object, String], default: "div" } },
    setup(t2, { slots: r2, attrs: o2 }) {
      let e2 = ref(null),
        p2 = computed(() => m$2(e2)),
        n2 = u$2(),
        u2 = inject(g$1, null),
        l2 = ref(n2 === true || u2 == null ? c(e2.value) : u2.resolveTarget());
      return (
        watchEffect(() => {
        ...
        onUnmounted(() => {
          ...
          let a2 =
            (i2 = p2.value) == null
              ? void 0
              : i2.getElementById("headlessui-portal-root");
          !a2 ||
            (l2.value === a2 &&
              l2.value.children.length <= 0 &&
              ((m2 = l2.value.parentElement) == null ||
                m2.removeChild(l2.value)));
        }),
        () => {
          if (l2.value === null) return null;
...
var p = ((e2) => (
  (e2[(e2.Add = 0)] = "Add"), (e2[(e2.Remove = 1)] = "Remove"), e2
))(p || {});
function v() {
  return inject(u$1, () => {});
}
...
function P({
  ...
  return (
    provide(u, { register: n2, slot: t2, name: o2, props: s2 }),
...
let S = defineComponent({
  ...
  setup(t2, { attrs: o2, slots: s2 }) {
    let e2 = b(),
      n2 = `headlessui-description-${t$1()}`;
    return (
      onMounted(() => onUnmounted(e2.register(n2))),
      () => {
        let {
            name: r2 = "Description",
            slot: i2 = ref({}),
          ...
          c2 = t2,
          d2 = {
            ...Object.entries(l2).reduce(
              (f2, [a2, g2]) => Object.assign(f2, { [a2]: unref(g2) }),
              {}
            ),
            id: n2,
          };
  ...
  let a2 = [],
    ...
    t2 = {
      ...
      addEventListener(e2, n2, o2, r2) {
        return (
          e2.addEventListener(n2, o2, r2),
          t2.add(() => e2.removeEventListener(n2, o2, r2))
        );
      },
      ...
      async workQueue() {
        for (let e2 of i2.splice(0)) await e2();
      },
    };
  return t2;
}
...
var De = ((t2) => (
  (t2[(t2.Open = 0)] = "Open"), (t2[(t2.Closed = 1)] = "Closed"), t2
))(De || {});
...
let k = "DC8F892D-2EBD-447C-A4C8-A03058436FF4",
  Ne = defineComponent({
    ...
    props: {
      ...
      open: { type: [Boolean, String], default: k },
      initialFocus: { type: Object, default: null },
    },
    emits: { close: (a2) => true },
    setup(a$1, { emit: u2, attrs: t2, slots: s$12, expose: i2 }) {
      var A2;
      let g2 = ref(false);
      onMounted(() => {
        g2.value = true;
      ...
      let r2 = ref(0),
        ...
        S2 = computed(() =>
          a$1.open === k && d2 !== null
            ? u$4(d2.value, { [l$2.Open]: true, [l$2.Closed]: false })
            : a$1.open
        ),
        x2 = ref(/* @__PURE__ */ new Set()),
        m2 = ref(null),
        B2 = ref(null),
        I = computed(() => m$2(m2));
      ...
      if (typeof S2.value != "boolean")
        throw new Error(
          `You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${
            S2.value === k ? void 0 : a$1.open
          }`
        );
      let f$12 = computed(() => (g2.value && S2.value ? 0 : 1)),
        H2 = computed(() => f$12.value === 0),
        C2 = computed(() => r2.value > 1),
        G2 = inject(j$1, null) !== null,
        z = computed(() => (C2.value ? "parent" : "leaf"));
      g$2(
        m2,
        computed(() => (C2.value ? H2.value : false))
      ),
        S$1({
          type: "Dialog",
          enabled: computed(() => f$12.value === 0),
          element: m2,
          onUpdate: (o2, l2, n2) => {
            if (l2 === "Dialog")
              return u$4(o2, {
      ...
      let J2 = P({
          ...
          slot: computed(() => ({ open: S2.value })),
        }),
        Q = `headlessui-dialog-${t$1()}`,
        E2 = ref(null),
        O2 = {
          titleId: E2,
          panelRef: ref(null),
      ...
      return (
              ...
              ...Array.from(
                ...
                (e2) =>
                  !(
                    ...
                    e2.contains(o$1(B2)) ||
                    (O2.panelRef.value && e2.contains(O2.panelRef.value))
                  )
              ),
              (p2 = O2.panelRef.value) != null ? p2 : m2.value,
            ];
          },
          (o2, l2) => {
            O2.close(), nextTick(() => (l2 == null ? void 0 : l2.focus()));
          },
          computed(() => f$12.value === 0 && !C2.value)
        ),
        E$1(
          (A2 = I.value) == null ? void 0 : A2.defaultView,
          "keydown",
          (o2) => {
            o2.defaultPrevented ||
              (o2.key === o$2.Escape &&
                f$12.value === 0 &&
                (C2.value ||
                  (o2.preventDefault(), o2.stopPropagation(), O2.close())));
          }
        ),
        watchEffect((o$12) => {
          var W;
          if (f$12.value !== 0 || G2) return;
          let l2 = I.value;
          if (!l2) return;
          let n2 = s();
          function p2(v2, b2, X) {
            ...
            return (
              Object.assign(v2.style, { [b2]: X }),
              n2.add(() => {
                Object.assign(v2.style, { [b2]: Z });
              })
            );
          }
          let e2 = l2 == null ? void 0 : l2.documentElement,
            L2 =
              ((W = l2.defaultView) != null ? W : window).innerWidth -
              e2.clientWidth;
          if ((p2(e2, "overflow", "hidden"), L2 > 0)) {
            let v2 = e2.clientWidth - e2.offsetWidth,
              b2 = L2 - v2;
            p2(e2, "paddingRight", `${b2}px`);
          }
          if (o()) {
            let v2 = window.pageYOffset;
            p2(e2, "position", "fixed"),
              p2(e2, "marginTop", `-${v2}px`),
              p2(e2, "width", "100%"),
              n2.add(() => window.scrollTo(0, v2));
          }
          o$12(n2.dispose);
        }),
        watchEffect((o2) => {
          if (f$12.value !== 0) return;
          let l2 = o$1(m2);
          if (!l2) return;
          let n2 = new IntersectionObserver((p2) => {
            for (let e2 of p2)
              e2.boundingClientRect.x === 0 &&
                e2.boundingClientRect.y === 0 &&
                e2.boundingClientRect.width === 0 &&
                e2.boundingClientRect.height === 0 &&
                O2.close();
          });
        ...
        () => {
          let o2 = {
              ...
              id: Q,
              role: "dialog",
              "aria-modal": f$12.value === 0 ? true : void 0,
              "aria-labelledby": E2.value,
              "aria-describedby": J2.value,
            },
            { open: l2, initialFocus: n2, ...p2 } = a$1,
            e2 = { open: f$12.value === 0 };
          return h$2(P$1, { force: true }, () => [
            h$2(R, () =>
              h$2(L$1, { target: m2.value }, () =>
                h$2(P$1, { force: false }, () =>
                  h$2(
                    ee$1,
                    {
                      ...
                      features: H2.value
                        ? u$4(z.value, {
                            parent: ee$1.features.RestoreFocus,
                            leaf: ee$1.features.All & ~ee$1.features.FocusLock,
                          })
                        : ee$1.features.None,
                    },
                    () =>
                      P$3({
                        ...
                        attrs: t2,
                        slots: s$12,
                        visible: f$12.value === 0,
                        features: R$1.RenderStrategy | R$1.Static,
                        name: "Dialog",
                      })
                  )
                )
...
defineComponent({
  name: "DialogOverlay",
  props: { as: { type: [Object, String], default: "div" } },
  setup(a2, { attrs: u2, slots: t2 }) {
    let s2 = T("DialogOverlay"),
      i2 = `headlessui-dialog-overlay-${t$1()}`;
    function g2(r2) {
      r2.target === r2.currentTarget &&
        (r2.preventDefault(), r2.stopPropagation(), s2.close());
    }
    return () =>
      P$3({
        ourProps: { id: i2, "aria-hidden": true, onClick: g2 },
        theirProps: a2,
...
defineComponent({
  ...
  props: { as: { type: [Object, String], default: "div" } },
  inheritAttrs: false,
  setup(a2, { attrs: u2, slots: t2, expose: s2 }) {
    let i2 = T("DialogBackdrop"),
      g2 = `headlessui-dialog-backdrop-${t$1()}`,
      r2 = ref(null);
    return (
      s2({ el: r2, $el: r2 }),
      onMounted(() => {
      ...
      () => {
        let d2 = a2,
          S2 = { id: g2, ref: r2, "aria-hidden": true };
        return h$2(P$1, { force: true }, () =>
          h$2(R, () =>
            P$3({
              ourProps: S2,
              theirProps: { ...u2, ...d2 },
              slot: { open: i2.dialogState.value === 0 },
              attrs: u2,
              slots: t2,
              name: "DialogBackdrop",
            })
...
let _e = defineComponent({
    name: "DialogPanel",
    props: { as: { type: [Object, String], default: "div" } },
    setup(a2, { attrs: u2, slots: t2, expose: s2 }) {
      let i2 = T("DialogPanel"),
        g2 = `headlessui-dialog-panel-${t$1()}`;
  ...
  Ue = defineComponent({
    ...
    setup(a2, { attrs: u2, slots: t2 }) {
      let s2 = T("DialogTitle"),
        i2 = `headlessui-dialog-title-${t$1()}`;
      return (
        onMounted(() => {
...
S;
var w$1 = ((n2) => (
  (n2[(n2.Open = 0)] = "Open"), (n2[(n2.Closed = 1)] = "Closed"), n2
))(w$1 || {});
...
function C(l2) {
  ...
  if (r2 === null) {
    let n2 = new Error(
      `<${l2} /> is missing a parent <Disclosure /> component.`
    );
...
let A = defineComponent({
    ...
    setup(l2, { slots: r2, attrs: n2 }) {
      let d2 = `headlessui-disclosure-button-${t$1()}`,
        e2 = `headlessui-disclosure-panel-${t$1()}`,
        o2 = ref(l2.defaultOpen ? 0 : 1),
        i2 = ref(null),
        s2 = ref(null),
        u2 = {
          buttonId: d2,
            ...
            let c2 = (() =>
              a2
                ? a2 instanceof HTMLElement
                  ? a2
                  : a2.value instanceof HTMLElement
                  ? o$1(a2)
                  : o$1(u2.button)
                : o$1(u2.button))();
            c2 == null || c2.focus();
      ...
      return (
        provide(x, u2),
        c$1(computed(() => u$4(o2.value, { [0]: l$2.Open, [1]: l$2.Closed }))),
        () => {
          let { defaultOpen: a2, ...c2 } = l2,
            m2 = { open: o2.value === 0, close: u2.close };
          return P$3({
            theirProps: c2,
            ourProps: {},
            slot: m2,
  ...
  G = defineComponent({
    ...
    setup(l2, { attrs: r2, slots: n2, expose: d2 }) {
      let e2 = C("DisclosureButton"),
        o2 = H(),
        i2 = o2 === null ? false : o2 === e2.panelId,
        s2 = ref(null);
      d2({ el: s2, $el: s2 }),
        i2 ||
          watchEffect(() => {
      ...
      let u2 = b$2(
        computed(() => ({ as: l2.as, type: r2.type })),
        s2
      );
      function a2() {
        var t2;
        l2.disabled ||
          (i2
            ? (e2.toggleDisclosure(),
              (t2 = o$1(e2.button)) == null || t2.focus())
            : e2.toggleDisclosure());
      }
      function c2(t2) {
        var D;
      ...
      return () => {
        let t2 = { open: e2.disclosureState.value === 0 },
          D = i2
            ? { ref: s2, type: u2.value, onClick: a2, onKeydown: c2 }
            : {
                id: e2.buttonId,
                ref: s2,
                type: u2.value,
                "aria-expanded": l2.disabled
                  ? void 0
                  : e2.disclosureState.value === 0,
                "aria-controls": o$1(e2.panel) ? e2.panelId : void 0,
                disabled: l2.disabled ? true : void 0,
                onClick: a2,
                onKeydown: c2,
                onKeyup: m2,
              };
  ...
  J = defineComponent({
    ...
    setup(l2, { attrs: r2, slots: n2, expose: d2 }) {
      ...
      let o2 = p$1(),
        i2 = computed(() =>
          o2 !== null ? o2.value === l$2.Open : e2.disclosureState.value === 0
        );
      return () => {
        let s2 = { open: e2.disclosureState.value === 0, close: e2.close },
          u2 = { id: e2.panelId, ref: e2.panel };
        return P$3({
          ourProps: u2,
          theirProps: l2,
          slot: s2,
...
var fe$2 = ((v2) => (
  (v2[(v2.Open = 0)] = "Open"), (v2[(v2.Closed = 1)] = "Closed"), v2
))(fe$2 || {});
...
function V(m2) {
  ...
  if (S2 === null) {
    let v2 = new Error(
      `<${m2} /> is missing a parent <${ce$1.name} /> component.`
    );
...
let ce$1 = defineComponent({
    name: "Popover",
    props: { as: { type: [Object, String], default: "div" } },
    setup(m2, { slots: S2, attrs: v2, expose: E2 }) {
      var p2;
      let t2 = `headlessui-popover-button-${t$1()}`,
        e2 = `headlessui-popover-panel-${t$1()}`,
        b2 = ref(null);
      E2({ el: b2, $el: b2 });
      let u2 = ref(1),
        d2 = ref(null),
        ...
        h2 = computed(() => {
          var R2, C2;
          if (!o$1(d2) || !o$1(s2)) return false;
          for (let D of document.querySelectorAll("body > *"))
            if (
              Number(D == null ? void 0 : D.contains(o$1(d2))) ^
              Number(D == null ? void 0 : D.contains(o$1(s2)))
            )
              return true;
          let r2 = E$2(),
            a2 = r2.indexOf(o$1(d2)),
            f2 = (a2 + r2.length - 1) % r2.length,
            F2 = (a2 + 1) % r2.length,
            M2 = r2[f2],
            x2 = r2[F2];
          return (
            !((R2 = o$1(s2)) != null && R2.contains(M2)) &&
            !((C2 = o$1(s2)) != null && C2.contains(x2))
          );
        }),
        P2 = {
          popoverState: u2,
          ...
          button: d2,
          isPortalled: h2,
          beforePanelSentinel: g2,
          afterPanelSentinel: y$1,
          togglePopover() {
          ...
          close(r2) {
            ...
            let a2 = (() =>
              r2
                ? r2 instanceof HTMLElement
                  ? r2
                  : r2.value instanceof HTMLElement
                  ? o$1(r2)
                  : o$1(P2.button)
                : o$1(P2.button))();
            a2 == null || a2.focus();
      ...
      provide(ee, P2),
        c$1(computed(() => u$4(u2.value, { [0]: l$2.Open, [1]: l$2.Closed })));
      let I = {
          buttonId: t2,
          panelId: e2,
          close() {
        ...
        l2 = oe$2(),
        o2 = l2 == null ? void 0 : l2.registerPopover;
      function i2() {
        var r2, a2, f2, F2;
        return (F2 = l2 == null ? void 0 : l2.isFocusWithinPopoverGroup()) !=
          null
          ? F2
          : ((r2 = c2.value) == null ? void 0 : r2.activeElement) &&
              (((a2 = o$1(d2)) == null
                ? void 0
                : a2.contains(c2.value.activeElement)) ||
                ((f2 = o$1(s2)) == null
                  ? void 0
                  : f2.contains(c2.value.activeElement)));
      }
      return (
        watchEffect(() => (o2 == null ? void 0 : o2(I))),
        E$1(
          (p2 = c2.value) == null ? void 0 : p2.defaultView,
          "focus",
          (r2) => {
            var a2, f2;
            u2.value === 0 &&
              (i2() ||
                !d2 ||
                !s2 ||
                ((a2 = o$1(P2.beforePanelSentinel)) != null &&
                  a2.contains(r2.target)) ||
                ((f2 = o$1(P2.afterPanelSentinel)) != null &&
                  f2.contains(r2.target)) ||
                P2.closePopover());
          },
          true
        ),
        y(
          ...
          (r2, a2) => {
            ...
            P2.closePopover(),
              h$1(a2, F$2.Loose) ||
                (r2.preventDefault(), (f2 = o$1(d2)) == null || f2.focus());
          },
          computed(() => u2.value === 0)
        ),
        () => {
  ...
  ke = defineComponent({
    ...
    inheritAttrs: false,
    setup(m2, { attrs: S2, slots: v2, expose: E2 }) {
      let t2 = V("PopoverButton"),
        e2 = computed(() => m$2(t2.button));
      E2({ el: t2.button, $el: t2.button });
      let b2 = oe$2(),
        u2 = b2 == null ? void 0 : b2.closeOthers,
        d2 = ve(),
        g2 = d2 === null ? false : d2 === t2.panelId,
        y2 = ref(null),
        s2 = `headlessui-focus-sentinel-${t$1()}`;
      g2 ||
        watchEffect(() => {
          t2.button.value = y2.value;
        });
      let c2 = b$2(
        computed(() => ({ as: m2.as, type: S2.type })),
        y2
      );
      function h2(o2) {
        var i2, p2, r2, a2, f2;
        if (g2) {
          ...
          switch (o2.key) {
            ...
            case o$2.Enter:
              o2.preventDefault(),
                (p2 = (i2 = o2.target).click) == null || p2.call(i2),
                t2.closePopover(),
                (r2 = o$1(t2.button)) == null || r2.focus();
              break;
          }
        } else
          switch (o2.key) {
            ...
            case o$2.Enter:
              o2.preventDefault(),
                o2.stopPropagation(),
                t2.popoverState.value === 1 && (u2 == null || u2(t2.buttonId)),
                t2.togglePopover();
              break;
            case o$2.Escape:
              ...
              if (
                !o$1(t2.button) ||
                (((a2 = e2.value) == null ? void 0 : a2.activeElement) &&
                  !(
                    (f2 = o$1(t2.button)) != null &&
                    f2.contains(e2.value.activeElement)
                  ))
              )
                return;
      ...
      function I(o2) {
        ...
        m2.disabled ||
          (g2
            ? (t2.closePopover(), (i2 = o$1(t2.button)) == null || i2.focus())
            : (o2.preventDefault(),
              o2.stopPropagation(),
              t2.popoverState.value === 1 && (u2 == null || u2(t2.buttonId)),
              t2.togglePopover(),
              (p2 = o$1(t2.button)) == null || p2.focus()));
      }
      function l2(o2) {
        o2.preventDefault(), o2.stopPropagation();
      }
      return () => {
        let o2 = t2.popoverState.value === 0,
          i2 = { open: o2 },
          p2 = g2
            ? { ref: y2, type: c2.value, onKeydown: h2, onClick: I }
            : {
                ref: y2,
                id: t2.buttonId,
                type: c2.value,
                "aria-expanded": m2.disabled
                  ? void 0
                  : t2.popoverState.value === 0,
                "aria-controls": o$1(t2.panel) ? t2.panelId : void 0,
                disabled: m2.disabled ? true : void 0,
                onKeydown: h2,
                onKeyup: P2,
                onClick: I,
                onMousedown: l2,
        ...
        function a$1() {
          ...
          function F2() {
            u$4(r2.value, {
              [d$3.Forwards]: () => P$2(f2, M.First),
              [d$3.Backwards]: () => P$2(f2, M.Last),
            });
          }
          F2();
        }
...
defineComponent({
  ...
  setup(m2, { attrs: S2, slots: v2 }) {
    let E2 = V("PopoverOverlay"),
      t2 = `headlessui-popover-overlay-${t$1()}`,
      e2 = p$1(),
      b2 = computed(() =>
        e2 !== null ? e2.value === l$2.Open : E2.popoverState.value === 0
      );
    function u2() {
      E2.closePopover();
    }
    return () => {
      ...
      return P$3({
        ourProps: { id: t2, "aria-hidden": true, onClick: u2 },
        theirProps: m2,
        slot: d2,
        attrs: S2,
        slots: v2,
...
let Le = defineComponent({
    ...
    setup(m2, { attrs: S2, slots: v2, expose: E2 }) {
      let { focus: t2 } = m2,
        e2 = V("PopoverPanel"),
        b2 = computed(() => m$2(e2.panel)),
        u2 = `headlessui-focus-sentinel-before-${t$1()}`,
        d2 = `headlessui-focus-sentinel-after-${t$1()}`;
      E2({ el: e2.panel, $el: e2.panel }),
        provide(ne, e2.panelId),
        watchEffect(() => {
          var o2, i2;
          if (!t2 || e2.popoverState.value !== 0 || !e2.panel) return;
          let l2 = (o2 = b2.value) == null ? void 0 : o2.activeElement;
          ((i2 = o$1(e2.panel)) != null && i2.contains(l2)) ||
            P$2(o$1(e2.panel), M.First);
        });
      let g2 = p$1(),
        y2 = computed(() =>
          g2 !== null ? g2.value === l$2.Open : e2.popoverState.value === 0
        );
      function s2(l2) {
        var o2, i2;
        switch (l2.key) {
          case o$2.Escape:
            if (
              e2.popoverState.value !== 0 ||
              !o$1(e2.panel) ||
              (b2.value &&
                !(
                  (o2 = o$1(e2.panel)) != null &&
                  o2.contains(b2.value.activeElement)
                ))
            )
              return;
            l2.preventDefault(),
              l2.stopPropagation(),
              e2.closePopover(),
              (i2 = o$1(e2.button)) == null || i2.focus();
            break;
        }
      }
      function c2(l2) {
        ...
        !o2 ||
          !o$1(e2.panel) ||
          ((i2 = o$1(e2.panel)) != null && i2.contains(o2)) ||
          (e2.closePopover(),
          (((r2 =
            (p2 = o$1(e2.beforePanelSentinel)) == null
              ? void 0
              : p2.contains) == null
            ? void 0
            : r2.call(p2, o2)) ||
            ((f2 =
              (a2 = o$1(e2.afterPanelSentinel)) == null
                ? void 0
                : a2.contains) == null
              ? void 0
              : f2.call(a2, o2))) &&
            o2.focus({ preventScroll: true }));
      }
      let h2 = n();
      function P2() {
        let l2 = o$1(e2.panel);
        ...
        function o2() {
          u$4(h2.value, {
            ...
            [d$3.Backwards]: () => {
              var i2;
              (i2 = o$1(e2.button)) == null ||
                i2.focus({ preventScroll: true });
            },
          });
        }
        o2();
      ...
      function I() {
        ...
        function o2() {
          u$4(h2.value, {
            [d$3.Forwards]: () => {
              var x2, R2;
              let i2 = o$1(e2.button),
                p2 = o$1(e2.panel);
              if (!i2) return;
              let r2 = E$2(),
                a2 = r2.indexOf(i2),
                f2 = r2.slice(0, a2 + 1),
                M$1 = [...r2.slice(a2 + 1), ...f2];
              for (let C2 of M$1.slice())
                if (
                  ((R2 =
                    (x2 = C2 == null ? void 0 : C2.id) == null
                      ? void 0
                      : x2.startsWith) == null
                    ? void 0
                    : R2.call(x2, "headlessui-focus-sentinel-")) ||
                  (p2 == null ? void 0 : p2.contains(C2))
                ) {
      ...
      return () => {
        let l2 = { open: e2.popoverState.value === 0, close: e2.close },
          o2 = {
            ref: e2.panel,
            id: e2.panelId,
            onKeydown: s2,
            onFocusout: t2 && e2.popoverState.value === 0 ? c2 : void 0,
            tabIndex: -1,
          };
        return P$3({
          ourProps: o2,
          theirProps: { ...S2, ...w$4(m2, ["focus"]) },
          attrs: S2,
          slot: l2,
          slots: {
            ...v2,
            default: (...i2) => {
              ...
              return [
                h$2(Fragment, [
                  y2.value &&
                    e2.isPortalled.value &&
                    h$2(f, {
                      id: u2,
                      ref: e2.beforePanelSentinel,
                      features: a.Focusable,
                      as: "button",
                      type: "button",
                      onFocus: P2,
                    }),
                  (p2 = v2.default) == null ? void 0 : p2.call(v2, ...i2),
                  y2.value &&
                    e2.isPortalled.value &&
                    h$2(f, {
                      id: d2,
                      ref: e2.afterPanelSentinel,
                      features: a.Focusable,
                      as: "button",
                      type: "button",
                      onFocus: I,
  ...
  He = defineComponent({
    ...
    setup(m2, { attrs: S2, slots: v2, expose: E2 }) {
      ...
      function g2() {
        ...
        return (h2 = o$1(t2)) != null && h2.contains(c2)
          ? true
          : e2.value.some((P2) => {
              var I, l2;
              return (
                ((I = s2.getElementById(P2.buttonId)) == null
                  ? void 0
                  : I.contains(c2)) ||
                ((l2 = s2.getElementById(P2.panelId)) == null
                  ? void 0
                  : l2.contains(c2))
              );
            });
      ...
      function y2(s2) {
        for (let c2 of e2.value) c2.buttonId !== s2 && c2.close();
      }
      return (
        provide(te, {
          registerPopover: d2,
          unregisterPopover: u2,
          isFocusWithinPopoverGroup: g2,
          closeOthers: y2,
        }),
        () =>
          P$3({
...
let d$2 = defineComponent({
  props: { onFocus: { type: Function, required: true } },
  setup(t2) {
    let n2 = ref(true);
    return () =>
      n2.value
...
let oe$1 = defineComponent({
    name: "TabGroup",
    emits: { change: (l2) => true },
    props: {
      as: { type: [Object, String], default: "template" },
    ...
    inheritAttrs: false,
    setup(l2, { slots: i2, attrs: o2, emit: f2 }) {
      let e2 = ref(null),
        s2 = ref([]),
        n2 = ref([]),
        c2 = computed(() => l2.selectedIndex !== null),
        p2 = computed(() => (c2.value ? l2.selectedIndex : e2.value)),
        b2 = {
          selectedIndex: e2,
          orientation: computed(() =>
            l2.vertical ? "vertical" : "horizontal"
          ),
          activation: computed(() => (l2.manual ? "manual" : "auto")),
          tabs: s2,
          panels: n2,
          setSelectedIndex(t2) {
      ...
      return (
        ...
        watchEffect(() => {
          var R2;
          if (
            b2.tabs.value.length <= 0 ||
            (l2.selectedIndex === null && e2.value !== null)
          )
            return;
          let t2 = b2.tabs.value.map((y2) => o$1(y2)).filter(Boolean),
            r2 = t2.filter((y2) => !y2.hasAttribute("disabled")),
            d2 = (R2 = l2.selectedIndex) != null ? R2 : l2.defaultIndex;
          if (d2 < 0) e2.value = t2.indexOf(r2[0]);
          else if (d2 > b2.tabs.value.length)
            e2.value = t2.indexOf(r2[r2.length - 1]);
          else {
            let y2 = t2.slice(0, d2),
              u2 = [...t2.slice(d2), ...y2].find((T2) => r2.includes(T2));
            if (!u2) return;
  ...
  se$1 = defineComponent({
    name: "TabList",
    props: { as: { type: [Object, String], default: "div" } },
    setup(l2, { attrs: i2, slots: o2 }) {
      let f2 = E("TabList");
      return () => {
        let e2 = { selectedIndex: f2.selectedIndex.value },
          s2 = { role: "tablist", "aria-orientation": f2.orientation.value };
        return P$3({
          ourProps: s2,
          theirProps: l2,
          slot: e2,
  ...
  de = defineComponent({
    ...
    setup(l2, { attrs: i2, slots: o2, expose: f2 }) {
      let e2 = E("Tab"),
        s2 = `headlessui-tabs-tab-${t$1()}`,
        n2 = ref(null);
      f2({ el: n2, $el: n2 }),
        onMounted(() => e2.registerTab(n2)),
        onUnmounted(() => e2.unregisterTab(n2));
      let c2 = computed(() => e2.tabs.value.indexOf(n2)),
        p2 = computed(() => c2.value === e2.selectedIndex.value);
      function b2(a2) {
        var T2;
        let u2 = a2();
        if (u2 === N.Success && e2.activation.value === "auto") {
          let L2 = (T2 = m$2(n2)) == null ? void 0 : T2.activeElement,
            M2 = e2.tabs.value.findIndex((B2) => o$1(B2) === L2);
      ...
      function t$2(a2) {
        ...
        if (
          b2(() =>
            u$4(e2.orientation.value, {
              vertical() {
                return a2.key === o$2.ArrowUp
                  ? P$2(u2, M.Previous | M.WrapAround)
                  : a2.key === o$2.ArrowDown
                  ? P$2(u2, M.Next | M.WrapAround)
                  : N.Error;
              },
              horizontal() {
                return a2.key === o$2.ArrowLeft
                  ? P$2(u2, M.Previous | M.WrapAround)
                  : a2.key === o$2.ArrowRight
                  ? P$2(u2, M.Next | M.WrapAround)
                  : N.Error;
              },
            })
      ...
      let y2 = b$2(
        computed(() => ({ as: l2.as, type: i2.type })),
        n2
      );
      return () => {
        var T2;
        let a2 = { selected: p2.value },
          u2 = {
            ref: n2,
            onKeydown: t$2,
            onMousedown: R2,
            ...
            type: y2.value,
            "aria-controls":
              (T2 = o$1(e2.panels.value[c2.value])) == null ? void 0 : T2.id,
            "aria-selected": p2.value,
            tabIndex: p2.value ? 0 : -1,
            disabled: l2.disabled ? true : void 0,
          };
        return P$3({
          ourProps: u2,
  ...
  fe$1 = defineComponent({
    name: "TabPanels",
    props: { as: { type: [Object, String], default: "div" } },
    setup(l2, { slots: i2, attrs: o2 }) {
      let f2 = E("TabPanels");
      return () => {
        let e2 = { selectedIndex: f2.selectedIndex.value };
        return P$3({
  ...
  ce = defineComponent({
    ...
    setup(l2, { attrs: i2, slots: o2, expose: f$12 }) {
      let e2 = E("TabPanel"),
        s2 = `headlessui-tabs-panel-${t$1()}`,
        n2 = ref(null);
      f$12({ el: n2, $el: n2 }),
        onMounted(() => e2.registerPanel(n2)),
        onUnmounted(() => e2.unregisterPanel(n2));
      let c2 = computed(() => e2.panels.value.indexOf(n2)),
        p2 = computed(() => c2.value === e2.selectedIndex.value);
      return () => {
        var r2;
        let b2 = { selected: p2.value },
          t2 = {
            ref: n2,
            id: s2,
            role: "tabpanel",
            "aria-labelledby":
              (r2 = o$1(e2.tabs.value[c2.value])) == null ? void 0 : r2.id,
            tabIndex: p2.value ? 0 : -1,
          };
        return !p2.value && l2.unmount && !l2.static
          ? h$2(f, { as: "span", ...t2 })
          : P$3({
              ourProps: t2,
              theirProps: l2,
              ...
              attrs: i2,
              slots: o2,
              features: R$1.Static | R$1.RenderStrategy,
              visible: p2.value,
              name: "TabPanel",
            });
      };
...
var g = ((i2) => (
  (i2.Finished = "finished"), (i2.Cancelled = "cancelled"), i2
))(g || {});
function F$1(e2, t2) {
  let i2 = s();
  if (!e2) return i2.dispose;
  let { transitionDuration: n2, transitionDelay: a2 } = getComputedStyle(e2),
    [l2, s$12] = [n2, a2].map((o2) => {
      let [u2 = 0] = o2
        .split(",")
        .filter(Boolean)
        .map((r2) =>
          r2.includes("ms") ? parseFloat(r2) : parseFloat(r2) * 1e3
        )
        .sort((r2, c2) => c2 - r2);
      return u2;
    });
  return (
    l2 !== 0 ? i2.setTimeout(() => t2("finished"), l2 + s$12) : t2("finished"),
    i2.add(() => t2("cancelled")),
    i2.dispose
  );
}
  ...
  return (
    ...
    s$12.nextFrame(() => {
      d$1(e2, ...i2),
        m(e2, ...n2),
        s$12.add(
          F$1(e2, (u2) => (d$1(e2, ...n2, ...t2), m(e2, ...a2), o2(u2)))
        );
    }),
    s$12.add(() => d$1(e2, ...t2, ...i2, ...n2, ...a2)),
    s$12.add(() => o2("cancelled")),
    s$12.dispose
  );
}
function d(e2 = "") {
...
var ae = ((a2) => ((a2.Visible = "visible"), (a2.Hidden = "hidden"), a2))(
  ae || {}
);
function le() {
...
function w(e2) {
  return "children" in e2
    ? w(e2.children)
    : e2.value.filter(({ state: t2 }) => t2 === "visible").length > 0;
}
function K(e2) {
  let t2 = ref([]),
    a2 = ref(false);
  ...
  function v2(r2) {
    ...
    return (
      n2
        ? n2.state !== "visible" && (n2.state = "visible")
        : t2.value.push({ id: r2, state: "visible" }),
      () => s2(r2, O$1.Unmount)
    );
  }
...
let _ = R$1.RenderStrategy,
  oe = defineComponent({
    ...
    setup(e2, { emit: t2, attrs: a2, slots: s2, expose: v2 }) {
      if (!le() && f$1())
        return () =>
          h$2(
            fe,
            {
              ...e2,
              onBeforeEnter: () => t2("beforeEnter"),
              onAfterEnter: () => t2("afterEnter"),
              onBeforeLeave: () => t2("beforeLeave"),
              onAfterLeave: () => t2("afterLeave"),
            },
            s2
          );
      let r2 = ref(null),
        n2 = ref("visible"),
        l2 = computed(() => (e2.unmount ? O$1.Unmount : O$1.Hidden));
      v2({ el: r2, $el: r2 });
      let { show: i2, appear: x2 } = ie(),
        { register: g$12, unregister: p2 } = se(),
        R2 = { value: true },
        m2 = t$1(),
        S2 = { value: false },
        N2 = K(() => {
      ...
      function Q(o2) {
        let c2 = R2.value && !x2.value,
          u2 = o$1(r2);
        !u2 ||
          !(u2 instanceof HTMLElement) ||
          c2 ||
          ((S2.value = true),
          i2.value && t2("beforeEnter"),
          i2.value || t2("beforeLeave"),
          o2(
            i2.value
              ? L(u2, k2, $, q, O2, (C2) => {
              ...
              : L(u2, z, G2, J2, O2, (C2) => {
                  (S2.value = false),
                    C2 === g.Finished &&
                      (w(N2) ||
                        ((n2.value = "hidden"), p2(m2), t2("afterLeave")));
                })
          ));
      }
      return (
        ...
        c$1(
          computed(() =>
            u$4(n2.value, { ["visible"]: l$2.Open, ["hidden"]: l$2.Closed })
          )
        ),
        () => {
          let {
  ...
  fe = defineComponent({
    ...
    setup(e2, { emit: t2, attrs: a2, slots: s2 }) {
      let v2 = p$1(),
        r2 = computed(() =>
          e2.show === null && v2 !== null
            ? u$4(v2.value, { [l$2.Open]: true, [l$2.Closed]: false })
            : e2.show
        );
      watchEffect(() => {
      ...
      let n2 = ref(r2.value ? "visible" : "hidden"),
        l2 = K(() => {
          n2.value = "hidden";
        }),
        i2 = ref(true),
        x2 = { show: r2, appear: computed(() => e2.appear || !i2.value) };
      return (
        onMounted(() => {
          watchEffect(() => {
            (i2.value = false),
        ...
        () => {
          let g2 = w$4(e2, [
            ...
            p2 = { unmount: e2.unmount };
          return P$3({
            ourProps: { ...p2, as: "template" },
            theirProps: {},
            slot: {},
            slots: {
              ...s2,
...
const _sfc_main$4 = {
  ...
  computed: {
    formattedSrc() {
      return `${this.src.url ? this.src.url : this.src.src}&width=${
        this.width
      }`;
    },
    formattedSrcSet() {
      ...
      this.srcsetWidths.forEach((w2) => {
        srcset += `${
          this.src.url ? this.src.url : this.src.src
        }&width=${w2} ${w2}w,`;
      });
      return srcset;
    },
...
const ImageTag = /* @__PURE__ */ _export_sfc(_sfc_main$4, [
  ["render", _sfc_render$4],
  [
    "__file",
    "/Users/kristenburgess/Desktop/Elementum/starter-theme/vue/components/ImageTag.vue",
  ],
]);
const _sfc_main$3 = {
  name: "Mega Menu",
  ...
  mounted() {
    ...
    this.blocks.forEach((block) => {
      var match = this.topMenu.find(
        (item) => item.title.toLowerCase() == block.settings.title.toLowerCase()
      );
      if (match != void 0) {
    ...
    const topLinks = Array.from(
      document.querySelectorAll(".header__menu-top .top-link > a")
    );
    var observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.attributeName == "aria-expanded") {
          var activeTopLink =
            topLinks.find((t2) => t2.getAttribute("aria-expanded") == "true") ||
            false;
          var triggerVisible =
            window.getComputedStyle(menuTrigger).display == "none"
              ? false
              : true;
          if (activeTopLink) {
            var isDropdown =
              activeTopLink.nextElementSibling.classList.contains(
          ...
          if (
            ...
            (activeTopLink &&
              !isDropdown &&
              activeTopLink.getAttribute("aria-expanded") == "true")
          ) {
...
const _hoisted_4$3 = { class: "mobile-header" };
const _hoisted_5$3 = ["onClick"];
const _hoisted_6$3 = { class: "icon target" };
const _hoisted_7$3 = ["width", "height"];
const _hoisted_8$3 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_9$3 = [_hoisted_8$3];
const _hoisted_10$3 = { class: "submenus" };
const _hoisted_11$3 = ["href"];
const _hoisted_12$3 = {
  key: 0,
  class: "icon target expand",
};
const _hoisted_13$3 = ["height", "width", "stroke-width"];
const _hoisted_14$3 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
...
const _hoisted_15$3 = [_hoisted_14$3];
const _hoisted_16$3 = ["href"];
const _hoisted_17$3 = {
  key: 0,
  class: "icon target expand",
};
const _hoisted_18$3 = ["height", "width", "stroke-width"];
const _hoisted_19$3 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
    d: "M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z",
    fill: "currentColor",
...
const _hoisted_20$3 = [_hoisted_19$3];
const _hoisted_21$3 = {
  key: 0,
  class: "mobile-links",
};
const _hoisted_22$3 = ["href"];
const _hoisted_23$2 = { class: "mobile-footer" };
const _hoisted_24$2 = ["href"];
const _hoisted_25$2 = { class: "icon target" };
const _hoisted_26$2 = ["width", "height", "stroke-width"];
const _hoisted_27$2 = /* @__PURE__ */ createBaseVNode(
  "circle",
  {
    cx: "12",
    cy: "6",
...
const _hoisted_28$1 = /* @__PURE__ */ createBaseVNode(
  "circle",
  {
    cx: "12",
    cy: "6",
...
const _hoisted_29$1 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
...
const _hoisted_30$1 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
    d: "M17.67 22a2 2 0 0 0 1.92-2.56A7.8 7.8 0 0 0 12 14a7.8 7.8 0 0 0-7.59 5.44A2 2 0 0 0 6.34 22Z",
  },
...
const _hoisted_37$1 = ["height", "width", "stroke-width"];
const _hoisted_38$1 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
    d: "M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z",
    fill: "currentColor",
...
const _hoisted_39$1 = [_hoisted_38$1];
...
const _hoisted_44$1 = { key: 1 };
const _hoisted_45$1 = {
  key: 2,
  class: "icon expand",
};
const _hoisted_46$1 = ["height", "width", "stroke-width"];
const _hoisted_47$1 = /* @__PURE__ */ createBaseVNode(
  "path",
  {
    d: "M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z",
    fill: "currentColor",
...
const _hoisted_48$1 = [_hoisted_47$1];
...
const _hoisted_53$1 = { class: "image_content__image-container" };
const _hoisted_54 = { key: 0 };
const _hoisted_55 = { key: 1 };
const _hoisted_56 = ["html"];
const _hoisted_57 = ["href"];
const _hoisted_58 = { class: "btn__label" };
const _hoisted_59 = ["href"];
const _hoisted_60 = { class: "btn__label" };
const _hoisted_61 = { class: "dropdown" };
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (
    openBlock(),
    createBlock(_component_Popover, null, {
      default: withCtx(() => [
        createVNode(
          _component_PopoverButton,
          {
            class: normalizeClass([
              "header__menu-trigger",
              { "hide-desktop": !$props.settings.collapse_menu_desktop },
            ]),
          ...
          ? (openBlock(),
            createBlock(
              ...
              },
              {
                default: withCtx(() => [
                  createVNode(
                    _component_PopoverPanel,
                    {
                      as: "nav",
                      class: normalizeClass([
                        "header__menu-collapsed",
                        [`color-scheme--${$props.settings.mm_color_scheme}`],
                      ]),
                    },
                    {
                      default: withCtx(({ close }) => [
                        ...
                        createBaseVNode("div", _hoisted_10$3, [
                          ...
                          createElementBlock(
                            Fragment,
                            null,
                            renderList($props.topMenu, (link, index) => {
                              return (
                                openBlock(),
                                createBlock(
                                  _component_Disclosure,
                                  {
                                    key: link.id,
                                  },
                                  {
                                    default: withCtx(({ open }) => [
                                      createBaseVNode(
                                        ...
                                        [
                                          createVNode(
                                            _component_DisclosureButton,
                                            {
                                              name: [
                                                `top-link_trigger_${index}`,
                                              ],
                        ...
                        $props.mobileLinks.length
                          ? (openBlock(),
                            createElementBlock("div", _hoisted_21$3, [
                              (openBlock(true),
                              createElementBlock(
                                Fragment,
                                null,
                                renderList($props.mobileLinks, (link) => {
                                  return (
                                    openBlock(),
                                    createElementBlock(
                                      "a",
                            ...
                            createVNode(
                              _component_PopoverGroup,
                              {
                                ...
                                class: normalizeClass([
                                  ...
                                  [
                                    `color-scheme--${$props.settings.mm_color_scheme}`,
                                    $props.settings.collapse_menu_desktop
                                      ? "collapsed"
                                      : "",
                                  ],
                                ]),
                                                                              ...
                                                                              normalizeClass(
                                                                                [
                                                                                  ...
                                                                                  [
                                                                                    ...
                                                                                    block.type ==
                                                                                    "menu"
                                                                                      ? `images-${block.settings.submenu_item_image}`
                                                                                      : "",
                                                                                  ],
                                                                                ]
                                                                              ),
                                                                                ...
                                                                                createElementBlock(
                                                                                  "div",
                                                                                  {
                                                                                    ...
                                                                                    class:
                                                                                      normalizeClass(
                                                                                        [
                                                                                          `images-${block.settings.submenu_item_image}__inner`,
                                                                                          `${block.type}__inner`,
                                                                                          `color-scheme--${$props.settings.mm_color_scheme}`,
                                                                                        ]
                                                                                      ),
                                                                                            ...
                                                                                            createBlock(
                                                                                              _component_image_tag,
                                                                                              {
                                                                                                ...
                                                                                                width:
                                                                                                  "960",
                                                                                                sizes:
                                                                                                  "(min-width: 1440px) 960px, (min-width: 1280px) 640px, 320px",
                                                                                                srcsetWidths:
                                                                                                  [
                                                                                                    960,
                                                                                                    640,
                                                                                                        ...
                                                                                                        class:
                                                                                                          normalizeClass(
                                                                                                            [
                                                                                                              "btn primary",
                                                                                                              [
                                                                                                                `btn-${block.settings.button_style}`,
                                                                                                                block
                                                                                                                  .settings
                                                                                                                  .button_reverse
                                                                                                                  ? "order-2"
...
const MegaMenu = /* @__PURE__ */ _export_sfc(_sfc_main$3, [
  ["render", _sfc_render$3],
  [
    "__file",
    "/Users/kristenburgess/Desktop/Elementum/starter-theme/vue/MegaMenu.vue",
  ],
]);
class MegaMenuApp {
  constructor(id, data) {
...
const _sfc_main$2 = {
  ...
  computed: {
    ...
    regularPrice() {
      ...
      var money_price = new Intl.NumberFormat(
    ...
    formattedDate() {
      return new Date(this.card.published_at).toLocaleDateString(
        `${window.Shopify.locale}-${window.Shopify.country}`,
...
const _hoisted_11$2 = [_hoisted_10$2];
const _hoisted_12$2 = ["id"];
const _hoisted_13$2 = /* @__PURE__ */ createBaseVNode(
  "span",
  { class: "btn__label" },
  " On Sale ",
  -1
);
const _hoisted_14$2 = [_hoisted_13$2];
...
const _hoisted_26$1 = /* @__PURE__ */ createBaseVNode(
  "span",
...
const _hoisted_47 = /* @__PURE__ */ createBaseVNode(
  "div",
  { class: "caption-spaced light" },
  "Shopify",
  -1
);
const _hoisted_48 = [_hoisted_46, _hoisted_47];
const _hoisted_49 = {
  key: 1,
  class: "price",
};
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.card
            ...
            createBaseVNode(
              ...
              [
                    ...
                    createElementBlock("div", _hoisted_2$2, [
                      createBaseVNode("div", _hoisted_3$2, [
                        createBaseVNode(
                          ...
                          {
                            srcset: [
                              $props.card.featured_image.width >= 165
                                ? `${$props.card.featured_image.url} 165w,`
                                : "",
                              $props.card.featured_image.width >= 360
                                ? `${$props.card.featured_image.url} 360w,`
                                : "",
                              $props.card.featured_image.width >= 533
                                ? `${$props.card.featured_image.url} 533w,`
                                : "",
                              $props.card.featured_image.width >= 720
                                ? `${$props.card.featured_image.url} 720w,`
                                : "",
                              $props.card.featured_image.width >= 940
                                ? `${$props.card.featured_image.url} 940w,`
                                : "",
                              $props.card.featured_image.width >= 1066
                                ? `${$props.card.featured_image.url} 1066w,`
                                : "",
                              `${$props.card.featured_image.url} ${$props.card.featured_image.width}w`,
                            ],
                            src: $props.card.featured_image,
                            sizes:
                              "(min-width: 1280px) calc((100vw - 130px) / 4), (min-width: 768px) calc((100vw - 120px) / 3), calc((100vw - 35px) / 2)",
                            alt: $props.card.featured_image.alt,
                            class: normalizeClass([
                              "card__image",
                              [$props.cardAspectRatio, $props.cardImageFit],
                            ]),
                ...
                createBaseVNode("div", _hoisted_5$2, [
                  $props.card.featured_image == null
                    ? (openBlock(),
                      createElementBlock("div", _hoisted_6$2, [
                        createBaseVNode(
                          "h3",
                          {
                            class: "card__heading",
                          ...
                          [
                            createBaseVNode(
                              "a",
                              {
                                href: $props.card.url,
                                id: [
                                  `StandardCardNoMediaLink-SearchModal-${$props.card.id}`,
                                ],
                                class: "full-unstyled-link",
                                "aria-labelledby": [
                                  `StandardCardNoMediaLink-SearchModal-${$props.card.id}`,
                                  `NoMediaStandardBadge-SearchModal-${$props.card.id}`,
                                ],
                              },
                              toDisplayString($props.card.title),
                              9,
                              _hoisted_8$2
                            ),
                          ],
                  ...
                  createBaseVNode(
                    ...
                    [
                      $props.card.available == false
                        ? (openBlock(),
                          createElementBlock(
                            "span",
                            {
                              ...
                              class: normalizeClass([
                                "badge badge--bottom-left btn",
                                [`btn-${$props.soldOutColor}`],
                              ]),
                            },
                            _hoisted_11$2,
                            10,
                        ...
                        : createCommentVNode("v-if", true),
                      $props.card.compare_at_price > $props.card.price &&
            ...
            createBaseVNode("div", _hoisted_15$2, [
              createBaseVNode("div", _hoisted_16$2, [
                $props.cardType == "article"
                  ? (openBlock(),
                    createElementBlock("div", _hoisted_17$2, [
                      createBaseVNode("div", _hoisted_18$2, [
                        $props.showTags && $props.card.tags.size > 0
                          ? (openBlock(),
                            createElementBlock(
                              "span",
                              _hoisted_19$2,
                              toDisplayString(
                                $props.card.tags.join(", ").substring(0, 25)
                              ),
                              1
                            ))
                          : createCommentVNode("v-if", true),
                        $props.showDate
                          ? (openBlock(),
                            createElementBlock(
                              "span",
                              _hoisted_20$2,
                              toDisplayString($options.formattedDate),
                              1
                            ))
                          : createCommentVNode("v-if", true),
                        $props.showAuthor
                          ? (openBlock(),
                            createElementBlock(
                              "span",
                              _hoisted_21$2,
                              toDisplayString($props.card.author),
                              1
                            ))
                          : createCommentVNode("v-if", true),
                      ]),
                  ...
                  [
                    createBaseVNode(
                      "a",
                      {
                        ...
                        class: "full-unstyled-link",
                        "aria-labelledby": [
                          `CardLink-SearchModal-${$props.card.id}`,
                          `Badge-SearchModal-${$props.card.id}`,
                        ],
                      },
                      toDisplayString(
                        $props.cardType == "article"
                          ? $props.card.title.length > 40
                            ? $props.card.title.substring(0, 30).concat("...")
                            : $props.card.title
                          : $props.card.title
                      ),
                      9,
                ...
                createBaseVNode("div", _hoisted_24$1, [
                  $props.cardType == "product" && $props.showVendor
                    ? (openBlock(),
                      createElementBlock("div", _hoisted_25$1, [
                        _hoisted_26$1,
                        createBaseVNode(
                          "div",
                          _hoisted_27$1,
                          toDisplayString($props.card.vendor),
                          1
                        ),
                      ]))
                    : createCommentVNode("v-if", true),
                  $props.cardType == "product" && $props.showPrice
                    ? (openBlock(),
                        ...
                        createBaseVNode("div", _hoisted_29, [
                          createBaseVNode("div", _hoisted_30, [
                            ...
                            createBaseVNode(
                              "span",
                              _hoisted_32,
                              toDisplayString($options.regularPrice),
                              1
                            ),
                          ]),
                          createBaseVNode("div", _hoisted_33, [
                            $props.card.price_varies &&
                            $props.card.compare_at_price_varies == false
                              ? (openBlock(),
                                createElementBlock("div", _hoisted_34, [
                                  _hoisted_35,
                            ...
                            createBaseVNode(
                              "span",
                              _hoisted_38,
                              toDisplayString($options.compareAtPrice),
                              1
                            ),
                          ]),
                        ]),
    ...
    : (openBlock(),
      createElementBlock("div", _hoisted_39, [
        createBaseVNode(
          "div",
          {
            class: normalizeClass([
            ...
            createBaseVNode("div", _hoisted_41, [
              createBaseVNode("div", _hoisted_42, [
                ...
                createBaseVNode("div", _hoisted_44, [
                  $props.showVendor
                    ? (openBlock(),
                      createElementBlock("div", _hoisted_45, _hoisted_48))
                    : createCommentVNode("v-if", true),
                  $props.showPrice
                    ? (openBlock(),
                      createElementBlock("div", _hoisted_49, [
...
const Card = /* @__PURE__ */ _export_sfc(_sfc_main$2, [
  ["render", _sfc_render$2],
  [
    "__file",
    "/Users/kristenburgess/Desktop/Elementum/starter-theme/vue/components/Card.vue",
  ],
]);
const _sfc_main$1 = {
  name: "SearchMenu",
  ...
  methods: {
    ...
    async getPredictiveResults() {
      if (this.query && this.query.length > 0) {
        ...
        var searchUrl = `${
          window.routes.predictive_search_url
        }.json?q=${encodeURIComponent(
          this.query
        )}&resources[type]=${encodeURIComponent(
  ...
  mounted() {
    ...
    const searchButton = document.querySelector(
      "#searchMenuTop .header__icon-link"
    );
    var observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.attributeName == "aria-expanded") {
          if (searchButton.getAttribute("aria-expanded") == "true") {
            ...
            if (this.searchPosition == "below") {
              this.resultsHeight =
                window.innerHeight - this.calculateResultsOffset();
            }
...
const _hoisted_18$1 = { class: "btn__label" };
const _hoisted_19$1 = {
  key: 1,
...
const _hoisted_20$1 = {
  class:
    "search__products shopify-grid product-grid grid--2-col-tablet-down grid--4-col-desktop",
};
const _hoisted_21$1 = {
  class:
    "search__articles shopify-grid product-grid grid--2-col-tablet-down grid--4-col-desktop",
};
const _hoisted_22$1 = { class: "search__pages" };
                  ...
                  },
                  {
                    default: withCtx(({ close }) => [
                      createBaseVNode("form", _hoisted_7$1, [
                        ...
                        withDirectives(
                          ...
                          [
                            ...
                            [
                              _directive_debounce,
                              $props.predictiveSearchEnabled
                                ? $options.getPredictiveResults()
                                : null,
                              "200",
                            ],
                          ]
                      ...
                      createVNode(
                        ...
                        {
                          default: withCtx(() => [
                            $data.query != "" && $props.predictiveSearchEnabled
                              ? (openBlock(),
                                createElementBlock(
                                  "div",
                                  {
                                    ...
                                    style: normalizeStyle([
                                      $props.searchPosition == "below"
                                        ? { height: $data.resultsHeight + "px" }
                                        : {},
                                    ]),
                                                        ...
                                                        return (
                                                          ...
                                                          createElementBlock(
                                                            "a",
                                                            {
                                                              ...
                                                              href: trend.url,
                                                              class:
                                                                "search__trends-tag btn secondary btn--small",
                                                            },
                                                            [
                                                              createBaseVNode(
                                                                "span",
...
const SearchMenu = /* @__PURE__ */ _export_sfc(_sfc_main$1, [
  ["render", _sfc_render$1],
  [
    "__file",
    "/Users/kristenburgess/Desktop/Elementum/starter-theme/vue/SearchMenu.vue",
  ],
]);
class SearchMenuApp {
  constructor(id, data) {
        ...
        default: withCtx(() => [
          createVNode(
            _component_Dialog,
            {
              ...
              onClose:
                _cache[2] || (_cache[2] = ($event) => ($data.isOpen = false)),
            },
            {
              default: withCtx(() => [
                createVNode(
                          ...
                          createBaseVNode(
                            "div",
                            {
                              class: normalizeClass([
                                "section-modal",
                                [
                                  $props.settings.float_modal_content ||
                                  $props.settings.overlay > 0
                                    ? "section-modal--float-content"
                                    : "section-modal--stacked",
                                  $props.settings.overlay > 0
                                    ? "section-modal--borderless"
                                    : "",
                                  `color-scheme--${$props.settings.color_scheme}`,
                                ],
                              ]),
                            },
                            [
                              _hoisted_4,
                              createVNode(
                                _component_DialogPanel,
                                { class: "section-modal__inner" },
                                {
                                  default: withCtx(() => [
                                      ...
                                      createBaseVNode("div", _hoisted_6, [
                                        createBaseVNode(
                                          "button",
                                          {
                                            type: "button",
                                            class:
                                              "hover:text-gray-500 icon target",
                                            onClick:
                                              _cache[0] ||
                                              (_cache[0] = ($event) =>
                                                ($data.isOpen = false)),
...
const Modal = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ...
  [
    "__file",
    "/Users/kristenburgess/Desktop/Elementum/starter-theme/vue/Modal.vue",
  ],
]);
class ModalApp {
  constructor(id, data) {
      ...
      event.target
        ...
        .forEach((appElement) => {
          ...
          eval == null
            ...
            : (0, eval)(
                `"use strict";(${
                  document.getElementById(`${eventSectionId}-${appType}`)
                    .innerHTML
                })`
              );
        });
...
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_account.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_hero.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_image-with-text.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_blog.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_product.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_modal.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_collapsible-content.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_collection-list.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_contact-content.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_contact-form.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_featured-collection.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_film-strip.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_hero-slideshow.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_media-collage.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_multicolumn.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_quick-add.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_testimonials.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_accordion.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_cart-drawer.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_cart-items.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_cart.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_cards.css")] : void 0,
  import.meta.url
);
__vitePreload(
  () => Promise.resolve({}),
  true ? [window.__toCdnUrl("assets/et_price.css")] : void 0,
  import.meta.url
);
if (window.location.href.includes("/collection/")) {
  __vitePreload(
    () => Promise.resolve({}),
    true ? [window.__toCdnUrl("assets/et_facets.css")] : void 0,
    import.meta.url
  );
}
if (window.location.href.includes("/search")) {
  __vitePreload(
    () => Promise.resolve({}),
    true ? [window.__toCdnUrl("assets/et_search.css")] : void 0,
    import.meta.url
  );
}
